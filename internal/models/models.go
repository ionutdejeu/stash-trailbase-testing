// Package models defines domain structs for database scanning.
package models
...
type Episode struct {
	...
	Embedding      vector.Vector `db:"embedding"`
...
type Pattern struct {
	...
	Content        string            `db:"content"`
	Confidence     float32           `db:"confidence"`
	SourceFactIDs  vector.Int64Slice `db:"source_fact_ids"`
	SourceRelIDs   vector.Int64Slice `db:"source_rel_ids"`
